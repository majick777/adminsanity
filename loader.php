...
// Loader Usage
// ============
// 1. replace all occurrences of adminsanity_ in this file with the plugin namespace prefix eg. my_plugin_
...
// $instance = new adminsanity_loader($args);				// instantiates loader class
// (ie. search and replace 'adminsanity_' with 'my_plugin_' function namespace)
	...
	class adminsanity_loader {
		...
		public function readme_viewer() {
			...
			if ( file_exists( $parser ) ) {
				...
				$readme = new adminsanity_readme_parser();
		...
		public function notice_boxer() {
			...
			if ( isset( $GLOBALS['adminsanity_data']['load']['notices'] ) && $GLOBALS['adminsanity_data']['load']['notices'] ) {
				return;
			}
...
add_action( 'plugins_loaded', 'adminsanity_load_prefixed_functions', 0 );

if ( !function_exists( 'adminsanity_load_prefixed_functions' ) ) {
	function adminsanity_load_prefixed_functions() {
		...
		if ( !function_exists( 'adminsanity_get_namespace_from_function' ) ) {
			function adminsanity_get_namespace_from_function( $f ) {
		...
		if ( !function_exists( 'adminsanity_loader_instance' ) ) {
			function adminsanity_loader_instance() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'adminsanity_freemius_instance' ) ) {
			function adminsanity_freemius_instance() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'adminsanity_plugin_data' ) ) {
			function adminsanity_plugin_data() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'adminsanity_plugin_version' ) ) {
			function adminsanity_plugin_version() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Set Pro Namespace
		// -----------------
		if ( !function_exists( 'adminsanity_pro_namespace' ) ) {
			function adminsanity_pro_namespace( $pronamespace ) {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Add Settings
		// ------------
		if ( !function_exists( 'adminsanity_add_settings' ) ) {
			function adminsanity_add_settings() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Defaults
		// ------------
		if ( !function_exists( 'adminsanity_default_settings' ) ) {
			function adminsanity_default_settings( $key = false ) {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Options
		// -----------
		if ( !function_exists( 'adminsanity_get_options' ) ) {
			function adminsanity_get_options() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Setting
		// -----------
		if ( !function_exists( 'adminsanity_get_setting' ) ) {
			function adminsanity_get_setting( $key, $filter = true ) {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'adminsanity_get_settings' ) ) {
			function adminsanity_get_settings( $filter = true ) {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Reset Settings
		// --------------
		if ( !function_exists( 'adminsanity_reset_settings' ) ) {
			function adminsanity_reset_settings() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Update Settings
		// ---------------
		if ( !function_exists( 'adminsanity_update_settings' ) ) {
			function adminsanity_update_settings() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Delete Settings
		// ---------------
		if ( !function_exists( 'adminsanity_delete_settings' ) ) {
			function adminsanity_delete_settings() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Message Box
		// -----------
		if ( !function_exists( 'adminsanity_message_box' ) ) {
			function adminsanity_message_box( $message, $echo = false ) {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Header
		// ---------------
		if ( !function_exists( 'adminsanity_settings_header' ) ) {
			function adminsanity_settings_header() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Page
		// -------------
		if ( !function_exists( 'adminsanity_settings_page' ) ) {
			function adminsanity_settings_page() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'adminsanity_settings_table' ) ) {
			function adminsanity_settings_table() {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'adminsanity_settings_row' ) ) {
			function adminsanity_settings_row( $option, $setting ) {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'adminsanity_settings_resources' ) ) {
			function adminsanity_settings_resources( $media, $color_picker ) {
				$namespace = adminsanity_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
